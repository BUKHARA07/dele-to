    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center max-w-4xl mx-auto">
          <Link
            href="https://github.com/ardd/dele-to-deployed"
            target="_blank"
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight">
            ...
            <br />
            that{" "}
            <span className="text-red-600 dark:text-red-500 animate-disappear">
              disappear
            </span>
          </h1>
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto hidden md:block">
            Stop sharing passwords in Slack. DELE.TO encrypts everything in your
            browser.
            <br />
            Your secrets self-destruct after reading. No traces, no logs, no
            worries.
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 mb-12">
            <Button
              asChild
              className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 text-lg rounded-lg transition-all duration-300 transform hover:scale-90w-auto"
            >
              <Link href="/create">
            ...
            <Button
              asChild
              variant="outline"
              className="border-gray-600 text-gray-300 hover:bg-gray-800 px-6 py-3 text-lg rounded-lg transition-all duration-300 transform hover:scale-90w-auto"
            >
        ...
        <div className="w-full max-w-6xl mx-auto mt-24 px-4 sm:px-6 lg:px-8 pb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 overflow-x-hidden">
            <Card className="bg-card border-border transition-all duration-300 hover:shadow-lg hover:scale-90hover:border-2 hover:border-red-500 dark:hover:border-red-400">
              ...
              <CardContent>
                <CardDescription className="text-muted-foreground">
                  Your data is encrypted with AES-256-GCM right in your browser.
            ...
            <Card className="bg-card border-border transition-all duration-300 hover:shadow-lg hover:scale-90hover:border-2 hover:border-red-500 dark:hover:border-red-400">
              ...
              <CardContent>
                <CardDescription className="text-muted-foreground">
                  Set custom expiration times or view limits. Once read, it's
                  gone forever.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card border-border transition-all duration-300 hover:shadow-lg hover:scale-90hover:border-2 hover:border-red-500 dark:hover:border-red-400">
              ...
              <CardContent>
                <CardDescription className="text-muted-foreground">
                  Encryption keys live in the URL fragment—they never touch our
                  servers.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card border-border transition-all duration-300 hover:shadow-lg hover:scale-90hover:border-2 hover:border-red-500 dark:hover:border-red-400">
              ...
              <CardContent>
                <CardDescription className="text-muted-foreground">
                  We don't log IPs, don't track users, and can't read your
                  secrets even if we tried.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card border-border transition-all duration-300 hover:shadow-lg hover:scale-90hover:border-2 hover:border-red-500 dark:hover:border-red-400">
              ...
              <CardContent>
                <CardDescription className="text-muted-foreground">
                  Fully auditable code on GitHub. Trust is earned through
                  transparency.
                </CardDescription>
              </CardContent>
            </Card>
